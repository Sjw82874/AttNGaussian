...
from scene.style_transfer import AdaAttN_new_IN
...
class GaussianModel:
    ...
    def restore(self, model_args, training_args=None, from_feature_model=False, from_style_model=False):
        ...
        if from_style_model:
            ...
            self._opacity,
            self.final_vgg_features,
            self.decoder_state_dict,
            self.style_transfer_state_dict) = model_args
            ...
            self.style_transfer = AdaAttN_new_IN().cuda()
            self.style_transfer.load_state_dict(self.style_transfer_state_dict)
    ...
    def training_setup_style(self, training_args, decoder_path, photorealistic=False):
        ...
        if decoder_path:
            ...
            final_vgg_features,
            decoder_state_dict,
            style_transfer_state_dict) = torch.load(decoder_path)
